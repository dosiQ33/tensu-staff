...
const AddSectionModal: React.FC<AddSectionModalProps> = ({ show, editing, allCoaches, newSection, onChange, onToggleCoach, onSave, onAdd, onClose }) => {
  if (!show) return null;
  return (
    <div className="fixed inset-0 bg-gray-50 bg-opacity-50 z-50 flex items-end pb-12">
      <div className="bg-white w-full max-h-[80vh] rounded-t-2xl overflow-hidden">
        <div className="sticky top-0 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-gray-900">{editing ? 'Edit Section' : 'Add New Section'}</h2>
