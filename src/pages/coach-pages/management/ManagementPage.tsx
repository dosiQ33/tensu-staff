...
const ManagementPage: React.FC = () => {
    ...
    () =>
      staff.filter((member) => {
        ...
        const matchesGroups =
          ...
          filters.groups.some((g) => member.groups.includes(g));

        const matchesSports =
          !filters.sports.length ||
          filters.sports.some((s) => member.sports.includes(s));
  ...
  const toggleArrayItem = <K extends keyof NewStaff>(
    array: string[],
    item: string,
    field: K
  ) => {
