        ...
        <div>
            ...
            <div className="flex items-center">
                ...
                <p className="text-sm font-medium text-gray-800">
                    {trainings[0].title} {trainings[0].subtitle && <span className="text-gray-500">– {trainings[0].subtitle}</span>}
                </p>
                </div>
            </div>
          ...
          />
              ...
              <Card className="col-span-full rounded-2xl shadow-lg bg-gradient-to-r from-green-400 to-blue-500 text-white">
                <CardContent className="p-4">
                  <h2 className="text-lg font-semibold mb-2">BARS CHECKMAT Monthly Goal</h2>
              ...
              <Card className="col-span-full rounded-2xl shadow-lg bg-gradient-to-r from-purple-400 to-blue-500 text-white">
                <CardContent className="p-4">
                  <h2 className="text-lg font-semibold mb-2">FOOTBALL CLUB Monthly Goal</h2>
                  <div className="flex items-center justify-between">
                    <div>
